export default {
  "Demo/WindowLock_Demo": {
    "CreationDate": "2025-06-06",
    "Commands": [
      {
        "Command": "echo",
        "Target": "=== Window-Lock Mode Demo ===",
        "Value": "blue",
        "Description": "This demo shows how to lock all desktop CV operations to a specific window area."
      },
      {
        "Command": "XDesktopAutomation",
        "Target": "true",
        "Value": "",
        "Description": "Switch to Desktop Automation mode"
      },
      {
        "Command": "echo",
        "Target": "STEP 1: Lock target window to center 1200x700 area (x=200, y=100)",
        "Value": "blue",
        "Description": ""
      },
      {
        "Command": "setTargetWindow",
        "Target": "200,100,1200,700",
        "Value": "",
        "Description": "Target = x,y,width,height in screen pixels. Lock all desktop CV ops to this area. Adjust to match your app window position."
      },
      {
        "Command": "echo",
        "Target": "Locked window: ${!TARGETWINDOW}",
        "Value": "green",
        "Description": "!TARGETWINDOW now contains the locked area coordinates"
      },
      {
        "Command": "captureDesktopScreenshot",
        "Target": "window_locked.png",
        "Value": "",
        "Description": "Screenshot is automatically cropped to the locked area (200,100,1200,700)"
      },
      {
        "Command": "echo",
        "Target": "Screenshot saved as window_locked.png - only the locked area was captured!",
        "Value": "green",
        "Description": ""
      },
      {
        "Command": "echo",
        "Target": "STEP 2: Visual search only runs inside the locked window",
        "Value": "blue",
        "Description": ""
      },
      {
        "Command": "echo",
        "Target": "STEP 3: Clear the lock - back to full desktop",
        "Value": "blue",
        "Description": ""
      },
      {
        ...
        "Target": "",
        "Value": "",
        "Description": "Target = empty string clears the lock. All subsequent ops use the full screen again."
      },
      {
        "Command": "echo",
        "Target": "Lock cleared. !TARGETWINDOW = '${!TARGETWINDOW}'",
        "Value": "green",
        "Description": ""
      },
      {
        "Command": "captureDesktopScreenshot",
        "Target": "full_screen.png",
        "Value": "",
        "Description": "This screenshot captures the full desktop (no lock active)"
      },
      {
        "Command": "echo",
        "Target": "Done! Compare window_locked.png vs full_screen.png to see the difference.",
